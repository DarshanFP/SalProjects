...
<div class="mb-3 card">
    <div class="card-header">
        <h4>2. Information about the trainees (Edit - Mode)</h4>
    </div>
    <div class="card-body">
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="number" name="education[below_9]" class="form-control" oninput="updateCounts()" value="{{ old('education.below_9', $report->education['below_9'] ?? '') }}"></td>
                </tr>
                <tr>
                    <td style="text-align: left;">10th class failed</td>
                    <td><input type="number" name="education[class_10_fail]" class="form-control" oninput="updateCounts()" value="{{ old('education.class_10_fail', $report->education['class_10_fail'] ?? '') }}"></td>
                </tr>
                <tr>
                    <td style="text-align: left;">10th class passed</td>
                    <td><input type="number" name="education[class_10_pass]" class="form-control" oninput="updateCounts()" value="{{ old('education.class_10_pass', $report->education['class_10_pass'] ?? '') }}"></td>
                </tr>
                <tr>
                    <td style="text-align: left;">Intermediate</td>
                    <td><input type="number" name="education[intermediate]" class="form-control" oninput="updateCounts()" value="{{ old('education.intermediate', $report->education['intermediate'] ?? '') }}"></td>
                </tr>
                <tr>
                    <td style="text-align: left;">Intermediate and above</td>
                    <td><input type="number" name="education[above_intermediate]" class="form-control" oninput="updateCounts()" value="{{ old('education.above_intermediate', $report->education['above_intermediate'] ?? '') }}"></td>
                </tr>
                <tr>
                    <td><input type="text" name="education[other]" class="form-control" placeholder="If any other, mention here" value="{{ old('education.other', $report->education['other'] ?? '') }}"></td>
                    <td><input type="number" name="education[other_count]" class="form-control" oninput="updateCounts()" value="{{ old('education.other_count', $report->education['other_count'] ?? '') }}"></td>
                </tr>
                <!-- Total -->
                <tr>
                    <td style="text-align: left;"><strong>Total</strong></td>
                    <td><input type="number" name="education[total]" class="form-control" readonly value="{{ old('education.total', $report->education['total'] ?? '') }}"></td>
                </tr>
            </tbody>
        </table>
    </div>
