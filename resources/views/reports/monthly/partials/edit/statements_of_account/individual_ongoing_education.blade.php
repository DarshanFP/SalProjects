            ...
            <tbody id="account-rows">
                ...
                @elseif(isset($budgets))
                    ...
                    <tr data-row-type="budget">
                        ...
                        <td><input type="number" name="amount_sanctioned[]" class="form-control" value="{{ old('amount_sanctioned.'.$index, $budget->amount ?? 0.00) }}" oninput="calculateRowTotals(this.closest('tr'))" readonly></td>
                        <td><input type="number" name="total_amount[]" class="form-control" value="{{ old('total_amount.'.$index, $budget->amount ?? 0.00) }}" readonly></td>
...
function addAccountRow() {
    ...
    newRow.innerHTML = `
        ...
        <td>${rowCount + 1}</td>
        <td class="particulars-cell"><input type="text" name="particulars[]" class="form-control" placeholder="Enter particulars" style="background-color: #202ba3;"></td>
