            ...
            <tbody id="account-rows">
                ...
                @elseif(isset($budgets))
                    ...
                    <tr data-row-type="budget">
                        ...
                        <td>{{ $index + 1 }}</td>
                        <td class="particulars-cell"><input type="hidden" name="particulars[]" value="{{ old('particulars.'.$index, $budget->name . ' - ' . $budget->study_proposed) }}"><span class="particulars-text">{{ old('particulars.'.$index, $budget->name . ' - ' . $budget->study_proposed) }}</span></td>
