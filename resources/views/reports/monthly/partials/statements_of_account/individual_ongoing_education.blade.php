...
function addAccountRow() {
    ...
    newRow.innerHTML = `
        ...
        <td>${rowCount + 1}</td>
        <td><input type="text" name="particulars[]" class="form-control" placeholder="Enter particulars" class="form-control report-active-input"></td>
        ...
        <td><input type="number" name="expenses_this_month[]" class="form-control" value="0.00" oninput="calculateRowTotals(this.closest('tr'))" class="form-control report-active-input"></td>
