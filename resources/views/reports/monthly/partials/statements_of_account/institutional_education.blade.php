            ...
            <tbody id="account-rows">
                ...
                @elseif(isset($budgets))
                    ...
                    <tr data-row-type="budget">
                        ...
                        <td><input type="number" name="total_amount[]" class="form-control" value="{{ old('total_amount.'.$index, ($budget->amount_forwarded ?? 0.00) + ($budget->iies_amount ?? 0.00)) }}" readonly></td>
