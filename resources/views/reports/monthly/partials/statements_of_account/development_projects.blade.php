...
<div class="mb-3 card">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-bordered report-form-table">
                <thead>
                    <tr>
                        <th>No.</th>
                        <th>Particulars</th>
                ...
                <tbody id="account-rows">
                    ...
                    @elseif(isset($budgets))
                        {{-- Create Mode: Use project budgets --}}
...
function addAccountRow() {
    ...
    newRow.innerHTML = `
        ...
        <td><input type="text" name="particulars[]" class="form-control" placeholder="Enter expense description" class="form-control report-active-input"></td>
