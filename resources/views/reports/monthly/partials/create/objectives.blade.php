    ...
    <div class="mb-3 card objective objective-card" data-index="{{ $index }}">
        ...
        <div class="card-body objective-form" style="display: none;">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea name="objective[{{ $index }}]" class="form-control auto-resize-textarea" rows="2" readonly>{{ old("objective.$index", $objective->objective) }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        @foreach($objective->results as $resultIndex => $result)
                            <textarea name="expected_outcome[{{ $index }}][{{ $resultIndex }}]" class="form-control auto-resize-textarea" rows="2" readonly>{{ old("expected_outcome.$index.$resultIndex", $result->result) }}</textarea>
                ...
                <div class="mb-3 card activity activity-card"
                    ...
                    <div class="card-body activity-form" style="display: none;">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="summary_activities[{{ $index }}][{{ $activityIndex }}][1]" class="form-control activity-field auto-resize-textarea" rows="3">{{ old("summary_activities.$index.$activityIndex.1") }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="qualitative_quantitative_data[{{ $index }}][{{ $activityIndex }}][1]" class="form-control activity-field auto-resize-textarea" rows="3">{{ old("qualitative_quantitative_data.$index.$activityIndex.1") }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="intermediate_outcomes[{{ $index }}][{{ $activityIndex }}][1]" class="form-control activity-field auto-resize-textarea" rows="3">{{ old("intermediate_outcomes.$index.$activityIndex.1") }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea name="not_happened[{{ $index }}]" class="form-control auto-resize-textarea" rows="3">{{ old("not_happened.$index") }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea name="why_not_happened[{{ $index }}]" class="form-control auto-resize-textarea" rows="3">{{ old("why_not_happened.$index") }}</textarea>
            ...
            <div class="mb-3 @if(old("changes.$index") != 'yes') d-none @endif" id="why_changes_container_{{ $index }}">
                ...
                <textarea name="why_changes[{{ $index }}]" class="form-control auto-resize-textarea" rows="3">{{ old("why_changes.$index") }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea name="lessons_learnt[{{ $index }}]" class="form-control auto-resize-textarea" rows="3">{{ old("lessons_learnt.$index") }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea name="todo_lessons_learnt[{{ $index }}]" class="form-control auto-resize-textarea" rows="3">{{ old("todo_lessons_learnt.$index") }}</textarea>
...
/**
 * Reindex all activities for a specific objective after add/remove operations
 * Updates index badges, data-activity-index attributes, form field names, and status badge IDs
 * Ensures sequential numbering (1, 2, 3, ...) for all activities within an objective
 *
...
/**
 * Toggle objective card expand/collapse state
 * Expands or collapses the objective form and updates the toggle icon
 *
 * @param {HTMLElement} header - The objective card header element that was clicked
 */
...
/**
 * Toggle activity card expand/collapse state
 * Expands or collapses the activity form and updates the toggle icon
 *
 * @param {HTMLElement} header - The activity card header element that was clicked
 */
...
/**
 * Update activity status badge based on form completion
 * Status: "Complete" (green) - all fields filled, "In Progress" (blue) - some fields filled, "Empty" (yellow) - no fields filled
 *
