                    ...
                    <tbody>
                        @foreach($report->accountDetails as $accountDetail)
                            <tr>
                                ...
                                <td class="col-numeric report-cell-entered">{{ format_indian_currency($accountDetail->expenses_last_month, 2) }}</td>
                                <td class="col-numeric report-cell-entered">{{ format_indian_currency($accountDetail->expenses_this_month, 2) }}</td>
                                <td class="col-numeric report-cell-entered">{{ format_indian_currency($accountDetail->total_expenses, 2) }}</td>
                                <td class="col-numeric report-cell-entered">{{ format_indian_currency($accountDetail->balance_amount, 2) }}</td>
                            </tr>
                        @endforeach
                        {{-- Total Row --}}
                        <tr class="table-info font-weight-bold">
                            ...
                            <td class="col-numeric report-cell-entered"><strong>{{ format_indian_currency($report->accountDetails->sum('expenses_last_month'), 2) }}</strong></td>
                            <td class="col-numeric report-cell-entered"><strong>{{ format_indian_currency($report->accountDetails->sum('expenses_this_month'), 2) }}</strong></td>
                            <td class="col-numeric report-cell-entered"><strong>{{ format_indian_currency($report->accountDetails->sum('total_expenses'), 2) }}</strong></td>
                            <td class="col-numeric report-cell-entered"><strong>{{ format_indian_currency($report->accountDetails->sum('balance_amount'), 2) }}</strong></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
/* Slightly narrower last 4 columns so table fits; override if needed */
