        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4>Compare Quarterly Reports</h4>
                    <a href="{{ route('aggregated.quarterly.index') }}" class="btn btn-secondary btn-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('reports.aggregated.quarterly.compare') }}">
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> Select two different quarterly reports to compare. The comparison will analyze differences in beneficiaries, budget, expenses, objectives, and activities.
                        </div>

                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('aggregated.quarterly.index') }}" class="btn btn-secondary">Cancel</a>
