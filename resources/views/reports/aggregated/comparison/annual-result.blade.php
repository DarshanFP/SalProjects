        ...
        <div class="col-12">
            ...
            <div class="card mb-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4>Annual Report Comparison (Year-over-Year)</h4>
                    <div>
                        <a href="{{ route('aggregated.comparison.annual-form') }}" class="btn btn-secondary btn-sm">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header bg-primary text-white">
                            <h5>Year {{ $report1->year }} Report</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header bg-success text-white">
                            <h5>Year {{ $report2->year }} Report</h5>
                        </div>
                        <div class="card-body">
            ...
            <!-- Growth Analysis (Annual-specific) -->
            @if(isset($comparison['growth_analysis']))
            <div class="card mb-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>Metric</th>
                                    <th>Year {{ $report1->year }}</th>
                                    <th>Year {{ $report2->year }}</th>
                                    <th>Growth</th>
                                    <th>Growth %</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($comparison['growth_analysis'] as $metric => $data)
                                <tr>
                                    <td><strong>{{ ucfirst(str_replace('_', ' ', $metric)) }}</strong></td>
                                    <td>{{ number_format($data['year1'] ?? 0, 2) }}</td>
                                    <td>{{ number_format($data['year2'] ?? 0, 2) }}</td>
                                    <td>
                                        <span class="{{ ($data['growth'] ?? 0) >= 0 ? 'text-success' : 'text-danger' }}">
                                            {{ ($data['growth'] ?? 0) >= 0 ? '+' : '' }}{{ number_format($data['growth'] ?? 0, 2) }}
                                        </span>
                                    </td>
                                    <td>
                                        <span class="{{ ($data['growth_percentage'] ?? 0) >= 0 ? 'text-success' : 'text-danger' }}">
                                            {{ ($data['growth_percentage'] ?? 0) >= 0 ? '+' : '' }}{{ number_format($data['growth_percentage'] ?? 0, 2) }}%
                                        </span>
                                    </td>
                                </tr>
                                @endforeach
