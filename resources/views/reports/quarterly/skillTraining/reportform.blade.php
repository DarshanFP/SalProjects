                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" name="below_9" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">10th class failed</td>
                                    <td><input type="number" name="10_fail" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">10th class passed</td>
                                    <td><input type="number" name="10_pass" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Intermediate</td>
                                    <td><input type="number" name="intermediate" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Intermediate and above</td>
                                    <td><input type="number" name="above_intermediate" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td><input type="text" name="other_education" class="form-control" placeholder="If any other, mention here"></td>
                                    <td><input type="number" name="count_other_education" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <!-- Total -->
                                <tr>
                            ...
                            <div class="monthly-summary-container" data-index="1">
                                <div class="mb-3 card activity" data-activity-index="1">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm remove-activity d-none" onclick="removeActivity(this)">Remove</button>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelector('[name="prjct_amount_sanctioned"]').addEventListener('input', calculateTotalAmount);
        document.querySelector('[name="l_y_amount_forwarded"]').addEventListener('input', calculateTotalAmount);
    });
    ...
    function calculateTotalAmount() {
        const amountSanctioned = parseFloat(document.querySelector('[name="prjct_amount_sanctioned"]').value) || 0;
        const amountForwarded = parseFloat(document.querySelector('[name="l_y_amount_forwarded"]').value) || 0;
    ...
    function updateCounts() {
        ...
        const below9 = document.querySelector('input[name="below_9"]').value;
        const tenFail = document.querySelector('input[name="10_fail"]').value;
        const tenPass = document.querySelector('input[name="10_pass"]').value;
        const intermediate = document.querySelector('input[name="intermediate"]').value;
        const aboveIntermediate = document.querySelector('input[name="above_intermediate"]').value;
        const otherEducation = document.querySelector('input[name="count_other_education"]').value;
        ...
        // Set the total value
        document.querySelector('input[name="total_all_categories"]').value = total;
    }
</script>
