        ...
        <div class="col-md-12 col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="fp-text-center1">DEVELOPMENT LIVELIHOOD PROJECT REPORTS</h4>
                </div>
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-primary btn-sm">Ed1it</a>
                                    <a href="#" class="btn btn-secondary btn-sm">Review</a>
                                    <form action="#"  style="display:inline;">
                                    <a href="{{ route('quarterly.developmentLivelihood.show', $report->id) }}" class="btn btn-primary btn-sm">View</a>
