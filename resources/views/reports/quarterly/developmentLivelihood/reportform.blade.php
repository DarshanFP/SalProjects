                        ...
                        <div class="impact-group" data-index="1">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="impact[1]" id="impact_1" class="form-control auto-resize-textarea"></textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="challenges[1]" class="form-label">Challenges faced if any</label>
                                    <textarea name="challenges[1]" id="challenges_1" class="form-control auto-resize-textarea"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="impact-group" data-index="${currentIndex}">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="impact[${currentIndex}]" id="impact_${currentIndex}" class="form-control auto-resize-textarea"></textarea>
                </div>
                <div class="mb-3">
                    <label for="challenges[${currentIndex}]" class="form-label">Challenges faced if any</label>
                    <textarea name="challenges[${currentIndex}]" id="challenges_${currentIndex}" class="form-control auto-resize-textarea"></textarea>
                </div>
            </div>
        </div>
    `;
