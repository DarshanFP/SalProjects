        ...
        <div class="col-md-12 col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="fp-text-center1">CARE AND SUPPORT HOME FOR CHILDREN/WOMEN IN DISTRESS REPORTS</h4>
                </div>
                <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="#"  style="display:inline;">
                                        <a href="{{ route('quarterly.womenInDistress.show', $report->id) }}" class="btn btn-primary btn-sm">View</a>
