            ...
            <div class="mb-3 card">
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach($report->inmatesProfiles as $profile)
                            <tr>
                                <td style="text-align: left;">{{ ucwords(str_replace('_', ' ', $profile->age_category)) }}</td>
                                <td>{{ ucwords($profile->status) }}</td>
                                <td>{{ $profile->number }}</td>
                            </tr>
                            @endforeach
                            <tr>
                                <td style="text-align: left;" colspan="2"><strong>Total</strong></td>
                                <td>{{ $report->inmatesProfiles->sum('number') }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
