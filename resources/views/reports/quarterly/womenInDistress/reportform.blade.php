...
<div class="page-content">
    <div class="row justify-content-center">
        <div class="col-md-12 col-xl-12">
            <form action="{{ route('quarterly.womenInDistress.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Basic Information Section -->
                <div class="mb-3 card">
                    <div class="card-header">
                        <h4 class="fp-text-center1">TRACKING MANAGEMENT OF CARE AND SUPPORT HOME FOR CHILDREN/WOMEN IN DISTRESS</h4>
                ...
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="goal" class="form-control auto-resize-textarea" rows="3" ></textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Unmarried</td>
                                    <td><input type="number" name="number_children_below_18_unmarried" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Children below 18 yrs</td>
                                    <td>Married</td>
                                    <td><input type="number" name="number_children_below_18_married" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Children below 18 yrs</td>
                                    <td>Divorcee</td>
                                    <td><input type="number" name="number_children_below_18_divorcee" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Children below 18 yrs</td>
                                    <td>Deserted</td>
                                    <td><input type="number" name="number_children_below_18_deserted" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Children below 18 yrs</td>
                                    <td><input type="text" name="status_children_below_18_others" class="form-control" placeholder="If any other, mention here"></td>
                                    <td><input type="number" name="number_children_below_18_others" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: right;" colspan="2"><strong>Total Children below 18 years </strong></td>
                                    <td><input type="number" name="total_children_below_18" class="form-control" readonly></td>
                                </tr>
                                <!-- Women between 18 – 30 years -->
                                <tr>
                                    <td style="text-align: left;">Women between 18 – 30 years</td>
                                    <td>Unmarried</td>
                                    <td><input type="number" name="number_women_18_30_unmarried" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Women between 18 – 30 years</td>
                                    <td>Married</td>
                                    <td><input type="number" name="number_women_18_30_married" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Women between 18 – 30 years</td>
                                    <td>Divorcee</td>
                                    <td><input type="number" name="number_women_18_30_divorcee" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Women between 18 – 30 years</td>
                                    <td>Deserted</td>
                                    <td><input type="number" name="number_women_18_30_deserted" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Women between 18 – 30 years</td>
                                    <td><input type="text" name="status_women_18_30_others" class="form-control" placeholder="If any other, mention here"></td>
                                    <td><input type="number" name="number_women_18_30_others" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: right;" colspan="2"><strong>Total Women between 18 – 30 years </strong></td>
                                    <td><input type="number" name="total_women_18_30" class="form-control" readonly></td>
                                </tr>
                                <!-- Women between 31 – 50 years -->
                                <tr>
                                    <td style="text-align: left;">Women between 31 – 50 years</td>
                                    <td>Unmarried</td>
                                    <td><input type="number" name="number_women_31_50_unmarried" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Women between 31 – 50 years</td>
                                    <td>Married</td>
                                    <td ><input type="number" name="number_women_31_50_married" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Women between 31 – 50 years</td>
                                    <td>Divorcee</td>
                                    <td><input type="number" name="number_women_31_50_divorcee" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Women between 31 – 50 years</td>
                                    <td>Deserted</td>
                                    <td><input type="number" name="number_women_31_50_deserted" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Women between 31 – 50 years</td>
                                    <td><input type="text" name="status_women_31_50_others" class="form-control" placeholder="If any other, mention here"></td>
                                    <td><input type="number" name="number_women_31_50_others" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: right;" colspan="2"><strong>Total Women between 31 – 50 years</strong></td>
                                    <td><input type="number" name="total_women_31_50" class="form-control" readonly></td>
                                </tr>
                                <!-- Women above 50 -->
                                <tr>
                                    <td style="text-align: left;">Women above 50</td>
                                    <td>Unmarried</td>
                                    <td><input type="number" name="number_women_above_50_unmarried" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Women above 50</td>
                                    <td>Married</td>
                                    <td><input type="number" name="number_women_above_50_married" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Women above 50</td>
                                    <td>Divorcee</td>
                                    <td><input type="number" name="number_women_above_50_divorcee" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Women above 50</td>
                                    <td>Deserted</td>
                                    <td><input type="number" name="number_women_above_50_deserted" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">Women above 50</td>
                                    <td><input type="text" name="status_women_above_50_others" class="form-control" placeholder="If any other, mention here"></td>
                                    <td><input type="number" name="number_women_above_50_others" class="form-control" oninput="updateCounts()"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: right;" colspan="2"><strong>Total Women above 50</strong></td>
                                    <td><input type="number" name="total_women_above_50" class="form-control" readonly></td>
                                </tr>
                                <!-- Total -->
                                <tr>
                                    <td style="text-align: left;" colspan="2"><strong>Total</strong></td>
                                    <td><input type="number" name="total_all_categories" class="form-control" readonly></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="prjct_amount_sanctioned" class="form-label">Amount Sanctioned: Rs.</label>
                            <input type="number" name="prjct_amount_sanctioned" class="form-control" oninput="calculateTotalAmount()">
                        </div>
                        <div class="mb-3">
                            <label for="l_y_amount_forwarded" class="form-label">Amount Forwarded from the Last Financial Year: Rs.</label>
                            <input type="number" name="l_y_amount_forwarded" class="form-control" oninput="calculateTotalAmount()">
                        </div>
                        <div class="mb-3">
...
<script>
    ...
    function addObjective() {
        ...
        // Initialize auto-resize for new objective textareas using global function
        const newObjective = objectivesContainer.lastElementChild;
        if (newObjective && typeof initDynamicTextarea === 'function') {
            initDynamicTextarea(newObjective);
        }
    ...
    // Profile of Inmates counter
    document.addEventListener('DOMContentLoaded', function () {
        const ageGroups = ['children_below_18', 'women_18_30', 'women_31_50', 'women_above_50'];
        ageGroups.forEach(ageGroup => {
            document.querySelectorAll(`input[name^="number_${ageGroup}"]`).forEach(input => {
                input.addEventListener('input', updateCounts);
            });
        });

        function updateCounts() {
            let totalChildrenBelow18 = 0;
            let totalWomen1830 = 0;
            let totalWomen3150 = 0;
            let totalWomenAbove50 = 0;

            ageGroups.forEach(ageGroup => {
                document.querySelectorAll(`input[name^="number_${ageGroup}"]`).forEach(input => {
                    if (ageGroup === 'children_below_18') {
                        totalChildrenBelow18 += parseInt(input.value) || 0;
                    } else if (ageGroup === 'women_18_30') {
                        totalWomen1830 += parseInt(input.value) || 0;
                    } else if (ageGroup === 'women_31_50') {
                        totalWomen3150 += parseInt(input.value) || 0;
                    } else if (ageGroup === 'women_above_50') {
                        totalWomenAbove50 += parseInt(input.value) || 0;
                    }
                });
            });

            document.querySelector('input[name="total_children_below_18"]').value = totalChildrenBelow18;
            document.querySelector('input[name="total_women_18_30"]').value = totalWomen1830;
            document.querySelector('input[name="total_women_31_50"]').value = totalWomen3150;
            document.querySelector('input[name="total_women_above_50"]').value = totalWomenAbove50;
            document.querySelector('input[name="total_all_categories"]').value = totalChildrenBelow18 + totalWomen1830 + totalWomen3150 + totalWomenAbove50;
        }
    });
</script>
