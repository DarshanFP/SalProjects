            ...
            <div class="mb-3 card">
                ...
                <div class="card-body">
                    <div class="info-grid">
                        ...
                        <div class="info-label"><strong>Amount Sanctioned: Rs.</strong></div>
                        <div class="info-value">{{ $report->amount_sanctioned_overview }}</div>
                        <div class="info-label"><strong>Amount Forwarded from the Last Financial Year: Rs.</strong></div>
                        <div class="info-value">{{ $report->amount_forwarded_overview }}</div>
                        <div class="info-label"><strong>Total Amount: Rs.</strong></div>
                        <div class="info-value">{{ $report->amount_in_hand }}</div>
                    </div>
                    ...
                    <div class="mt-3 info-grid">
                        <div class="info-label"><strong>Total Balance Amount Forwarded for the Following Month: Rs.</strong></div>
                        <div class="info-value">{{ $report->total_balance_forwarded }}</div>
                    </div>
                </div>
            </div>
