                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="up_to_previous_below_5_1" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="present_academic_below_5_1" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Children below 5 years</td>
                                    ...
                                    <td>
                                        <input type="text" name="up_to_previous_below_5_2" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="present_academic_below_5_2" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Children below 5 years</td>
                                    ...
                                    <td>
                                        <input type="text" name="up_to_previous_below_5_3" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="present_academic_below_5_3" class="form-control">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="up_to_previous_6_10_1" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="present_academic_6_10_1" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Children between 6 to 10 years</td>
                                    <td>Bridge course</td>
                                    <td>
                                        <input type="text" name="up_to_previous_6_10_2" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="present_academic_6_10_2" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Children between 6 to 10 years</td>
                                    ...
                                    <td>
                                        <input type="text" name="up_to_previous_6_10_3" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="present_academic_6_10_3" class="form-control">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="up_to_previous_11_15_1" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="present_academic_11_15_1" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Children between 11 to 15 years</td>
                                    <td>High school</td>
                                    <td>
                                        <input type="text" name="up_to_previous_11_15_2" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="present_academic_11_15_2" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Children between 11 to 15 years</td>
                                    ...
                                    <td>
                                        <input type="text" name="up_to_previous_11_15_3" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="present_academic_11_15_3" class="form-control">
                                    </td>
                                </tr>
                                <!-- 16 and above -->
                                <tr>
                                    ...
                                    <td>Undergraduate</td>
                                    <td>
                                        <input type="text" name="up_to_previous_16_above_1" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="present_academic_16_above_1" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td>16 and above</td>
                                    ...
                                    <td>
                                        <input type="text" name="up_to_previous_16_above_2" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="present_academic_16_above_2" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td>16 and above</td>
                                    ...
                                    <td>
                                        <input type="text" name="up_to_previous_16_above_3" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="present_academic_16_above_3" class="form-control">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
