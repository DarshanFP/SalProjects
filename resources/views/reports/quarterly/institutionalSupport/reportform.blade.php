...
<div class="page-content">
    <div class="row justify-content-center">
        <div class="col-md-12 col-xl-12">
            <form action="{{ route('quarterly.institutionalSupport.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="beneficiary_statistics" class="form-label">Statistics of beneficiaries in the project</label>
                            <input type="number" name="beneficiary_statistics" class="form-control">
                        </div>
                        <div class="mb-3">
                            <label for="monitoring_period" class="form-label">Monitoring Period</label>
                        ...
                        <table class="table table-bordered" id="age-profile-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="education_below_5_1" class="form-control">
                                            <option value="Bridge course">Bridge course</option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="number" name="up_to_previous_below_5_1" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                    <td>
                                        <input type="number" name="present_academic_below_5_1" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Children below 5 years</td>
                                    <td>
                                        <select name="education_below_5_2" class="form-control">
                                            <option value="Kindergarten">Kindergarten</option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="number" name="up_to_previous_below_5_2" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                    <td>
                                        <input type="number" name="present_academic_below_5_2" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Children below 5 years</td>
                                    <td>
                                        <input type="text" name="education_below_5_3" class="form-control" placeholder="If any other, mention here">
                                    </td>
                                    <td>
                                        <input type="number" name="up_to_previous_below_5_3" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                    <td>
                                        <input type="number" name="present_academic_below_5_3" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                </tr>
                                <!-- Total row for Children below 5 years -->
                                <tr class="total-row">
                                    <td style="text-align: right;" colspan="2"><strong>Total below 5 years</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="education_6_10_1" class="form-control">
                                            <option value="Primary school">Primary school</option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="number" name="up_to_previous_6_10_1" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                    <td>
                                        <input type="number" name="present_academic_6_10_1" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Children between 6 to 10 years</td>
                                    <td>
                                        <select name="education_6_10_2" class="form-control">
                                            <option value="Bridge course">Bridge course</option>
                                        </select>
                                    </td>

                                    <td>
                                        <input type="number" name="up_to_previous_6_10_2" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                    <td>
                                        <input type="number" name="present_academic_6_10_2" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Children between 6 to 10 years</td>
                                    <td>
                                        <input type="text" name="education_6_10_3" class="form-control" placeholder="If any other, mention here">
                                    </td>
                                    <td>
                                        <input type="number" name="up_to_previous_6_10_3" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                    <td>
                                        <input type="number" name="present_academic_6_10_3" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                </tr>
                                <!-- Total row for Children between 6 to 10 years -->
                                <tr class="total-row">
                                    <td style="text-align: right;" colspan="2"><strong>Total between 6 to 10 years</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="education_11_15_1" class="form-control">
                                        <option value="Secondary school">Secondary school</option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="number" name="up_to_previous_11_15_1" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                    <td>
                                        <input type="number" name="present_academic_11_15_1" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Children between 11 to 15 years</td>
                                    <td>
                                        <select name="education_11_15_2" class="form-control">
                                            <option value="High school">High school</option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="number" name="up_to_previous_11_15_2" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                    <td>
                                        <input type="number" name="present_academic_11_15_2" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Children between 11 to 15 years</td>
                                    <td>
                                        <input type="text" name="education_11_15_3" class="form-control" placeholder="If any other, mention here">
                                    </td>
                                    <td>
                                        <input type="number" name="up_to_previous_11_15_3" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                    <td>
                                        <input type="number" name="present_academic_11_15_3" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                </tr>
                                <!-- Total row for Children between 11 to 15 years -->
                                <tr class="total-row">
                                    <td style="text-align: right;" colspan="2"><strong>Total between 11 to 15 years</td>
                                ...
                                <tr>
                                    <td>16 and above</td>
                                    <td>
                                        <select name="education_16_above_1" class="form-control">
                                        <option value="Undergraduate">Undergraduate</option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="number" name="up_to_previous_16_above_1" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                    <td>
                                        <input type="number" name="present_academic_16_above_1" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                </tr>
                                <tr>
                                    <td>16 and above</td>
                                    <td>
                                        <select name="education_16_above_2" class="form-control">
                                        <option value="Technical/Vocational education">Technical/Vocational education</option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="number" name="up_to_previous_16_above_2" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                    <td>
                                        <input type="number" name="present_academic_16_above_2" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                </tr>
                                <tr>
                                    <td>16 and above</td>
                                    <td>
                                        <input type="text" name="education_16_above_3" class="form-control" placeholder="If any other, mention here">
                                    </td>
                                    <td>
                                        <input type="number" name="up_to_previous_16_above_3" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                    <td>
                                        <input type="number" name="present_academic_16_above_3" class="form-control" oninput="calculateAgeTotals()">
                                    </td>
                                </tr>
                                <!-- Total row for 16 and above -->
                                <tr class="total-row">
                                    <td style="text-align: right;" colspan="2"><strong>Total 16 and above</td>
                                ...
                                <!-- Grand Total -->
                                <tr class="total-row">
                                    <td style="text-align: right;" colspan="2"><strong>Grand Total</td>
...
<script>
    ...
    function calculateAgeTotals() {
        const sections = [
            { prefix: 'below_5', rows: 3 },
            { prefix: '6_10', rows: 3 },
            { prefix: '11_15', rows: 3 },
            { prefix: '16_above', rows: 3 }
        ];
        ...
        sections.forEach(section => {
            ...
            for (let i = 1; i <= section.rows; i++) {
                totalUpToPrevious += parseFloat(document.querySelector(`[name="up_to_previous_${section.prefix}_${i}"]`).value) || 0;
                totalPresentAcademic += parseFloat(document.querySelector(`[name="present_academic_${section.prefix}_${i}"]`).value) || 0;
            }
