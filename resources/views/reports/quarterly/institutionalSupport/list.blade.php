        ...
        <div class="col-md-12 col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="fp-text-center1">INSTITUTIONAL / NON-INSTITUTIONAL SUPPORT PROJECT REPORTS</h4>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('quarterly.institutionalSupport.show', $report->id) }}" class="btn btn-primary btn-sm">View</a>
