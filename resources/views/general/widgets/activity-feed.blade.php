...
<div class="card mb-4 widget-card" data-widget-id="activity-feed">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-2">
            ...
            <button type="button" class="btn btn-sm btn-outline-secondary widget-toggle" data-widget="activity-feed" title="Minimize">−</button>
        </div>
    </div>
                                ...
                                <div class="activity-item mb-3 p-3 border rounded activity-row"
                                    ...
                                    <div class="d-flex align-items-start">
                                        <div class="activity-icon me-3">
                                            <div class="avatar avatar-sm bg-{{ $activity->color ?? 'primary' }} text-white rounded-circle d-flex align-items-center justify-content-center" style="min-width: 36px; min-height: 36px;">&nbsp;</div>
                                        </div>
                                        <div class="activity-content flex-grow-1">
                                            ...
                                            <div class="activity-meta">
                                                <span class="badge bg-{{ $activity->type === 'project' ? 'primary' : 'info' }} me-2">{{ ucfirst($activity->type) }}</span>
                                                ...
                                                @if($activity->changedBy && $activity->changedBy->province)
                                                    <span class="badge bg-secondary me-2">{{ $activity->changedBy->province }}</span>
                                                @endif
