...
<div class="mb-3 card">
    ...
    <div class="card-body">
        <div class="mb-3">
            <textarea name="intervention_logic" class="form-control" rows="5" style="background-color: #202ba3;" placeholder="Describe the interventions...">{{ $intervention_logic }}</textarea>
        </div>
    </div>
</div>
