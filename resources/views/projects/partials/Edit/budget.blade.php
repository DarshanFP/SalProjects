<div class="mb-3 card">
    ...
    <div class="card-body">
        ...
        <input type="hidden" name="overall_project_budget" id="overall_project_budget" value="{{ old('overall_project_budget', $project->overall_project_budget ?? 0) }}">

        {{-- Legacy fields - keeping for backward compatibility but hidden --}}
        <input type="hidden" name="total_amount_sanctioned" id="total_amount_sanctioned" value="{{ old('total_amount_sanctioned', $project->total_amount_sanctioned) }}">
        <input type="hidden" name="total_amount_forwarded" value="{{ old('total_amount_forwarded', $project->total_amount_forwarded) }}">
    </div>
</div>
