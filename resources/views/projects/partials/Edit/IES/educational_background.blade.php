...
<div class="mb-3 card">
    ...
    <div class="card-body">
        @php
            $educationBackground = $project->iesEducationBackground ?? new \App\Models\OldProjects\IES\ProjectIESEducationBackground();
        @endphp

        <!-- Previous Class/Studies Information -->
        <div class="form-group">
            <label>Mention the previous class/studies for which the project support was given:</label>
        ...
        <div class="form-group">
            <label>Total amount of scholarship availed by the beneficiary from the government/any other agency in the previous year:</label>
