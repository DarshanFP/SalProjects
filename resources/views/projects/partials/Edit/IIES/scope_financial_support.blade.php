...
<div class="form-group">
    ...
    <div class="form-check">
        <input type="radio" name="govt_eligible_scholarship" class="form-check-input"
            value="1" {{ old('govt_eligible_scholarship', $IIESFinancialSupport->govt_eligible_scholarship ?? '') == '1' ? 'checked' : '' }}>
        <label class="form-check-label">Yes</label>
    </div>
    <div class="form-check">
        <input type="radio" name="govt_eligible_scholarship" class="form-check-input"
            value="0" {{ old('govt_eligible_scholarship', $IIESFinancialSupport->govt_eligible_scholarship ?? '') == '0' ? 'checked' : '' }}>
...
<div class="form-group">
    ...
    <input type="number" name="scholarship_amt" id="scholarship_amt" class="form-control" step="0.01"
        value="{{ old('scholarship_amt', $IIESFinancialSupport->scholarship_amt ?? '') }}">
</div>
...
<div class="form-group">
    ...
    <div class="form-check">
        <input type="radio" name="other_eligible_scholarship" class="form-check-input"
            value="1" {{ old('other_eligible_scholarship', $IIESFinancialSupport->other_eligible_scholarship ?? '') == '1' ? 'checked' : '' }}>
        <label class="form-check-label">Yes</label>
    </div>
    <div class="form-check">
        <input type="radio" name="other_eligible_scholarship" class="form-check-input"
            value="0" {{ old('other_eligible_scholarship', $IIESFinancialSupport->other_eligible_scholarship ?? '') == '0' ? 'checked' : '' }}>
        <label class="form-check-label">No</label>
    </div>
</div>
...
<div class="form-group">
    ...
    <input type="number" name="other_scholarship_amt" id="other_scholarship_amt" class="form-control" step="0.01"
        value="{{ old('other_scholarship_amt', $IIESFinancialSupport->other_scholarship_amt ?? '') }}">
</div>
...
<div class="form-group">
    ...
    <input type="number" name="family_contrib" id="family_contrib" class="form-control" step="0.01"
        value="{{ old('family_contrib', $IIESFinancialSupport->family_contrib ?? '') }}">
</div>
