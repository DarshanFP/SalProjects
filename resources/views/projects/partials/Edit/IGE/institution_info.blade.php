...
<div class="mb-3 card">
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <select name="institutional_type" class="form-control">
        ...
        <div class="form-group">
            ...
            <input type="number" name="previous_year_beneficiaries" class="form-control" value="{{ old('previous_year_beneficiaries', $IGEinstitutionInfo->previous_year_beneficiaries ?? '') }}">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="outcome_impact" class="form-control sustainability-textarea" rows="4">{{ old('outcome_impact', $IGEinstitutionInfo->outcome_impact ?? '') }}</textarea>
        </div>
    </div>
</div>
