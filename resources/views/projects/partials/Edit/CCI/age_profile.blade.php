            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="education_below_5_other_prev_year" value="{{ $ageProfile->education_below_5_other_prev_year ?? '' }}" class="form-control"></td>
                        <td><input type="text" name="education_below_5_other_current_year" value="{{ $ageProfile->education_below_5_other_current_year ?? '' }}" class="form-control"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="education_6_10_other_prev_year" value="{{ $ageProfile->education_6_10_other_prev_year ?? '' }}" class="form-control"></td>
                        <td><input type="text" name="education_6_10_other_current_year" value="{{ $ageProfile->education_6_10_other_current_year ?? '' }}" class="form-control"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="education_11_15_other_prev_year" value="{{ $ageProfile->education_11_15_other_prev_year ?? '' }}" class="form-control"></td>
                        <td><input type="text" name="education_11_15_other_current_year" value="{{ $ageProfile->education_11_15_other_current_year ?? '' }}" class="form-control"></td>
                    </tr>
