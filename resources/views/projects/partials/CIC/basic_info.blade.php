...
<div class="mb-4 card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="number_served_since_inception" id="number_served_since_inception" class="form-control" value="{{ old('number_served_since_inception') }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="number_served_previous_year" id="number_served_previous_year" class="form-control" value="{{ old('number_served_previous_year') }}">
        </div>

        <!-- Beneficiary categories -->
        <div class="mb-3">
            <label for="beneficiary_categories" class="form-label">Explain the categories of the beneficiaries</label>
            <textarea name="beneficiary_categories" id="beneficiary_categories" class="form-control sustainability-textarea" rows="3">{{ old('beneficiary_categories') }}</textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="sisters_intervention" id="sisters_intervention" class="form-control sustainability-textarea" rows="3">{{ old('sisters_intervention') }}</textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="beneficiary_conditions" id="beneficiary_conditions" class="form-control sustainability-textarea" rows="3">{{ old('beneficiary_conditions') }}</textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="beneficiary_problems" id="beneficiary_problems" class="form-control sustainability-textarea" rows="3">{{ old('beneficiary_problems') }}</textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="institution_challenges" id="institution_challenges" class="form-control sustainability-textarea" rows="3">{{ old('institution_challenges') }}</textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="support_received" id="support_received" class="form-control sustainability-textarea" rows="3">{{ old('support_received') }}</textarea>
        </div>

        <!-- Need of the project -->
        <div class="mb-3">
            <label for="project_need" class="form-label">Need of the current project</label>
            <textarea name="project_need" id="project_need" class="form-control sustainability-textarea" rows="3">{{ old('project_need') }}</textarea>
        </div>
    </div>
</div>
