    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            @if(!empty($IIESAttachments['iies_aadhar_card']))
                <p>Currently Attached: <a href="{{ Storage::url($IIESAttachments['iies_aadhar_card']) }}" target="_blank">View Document</a></p>
            @else
        ...
        <div class="mb-3">
            ...
            @if(!empty($IIESAttachments['iies_fee_quotation']))
                <p>Currently Attached: <a href="{{ Storage::url($IIESAttachments['iies_fee_quotation']) }}" target="_blank">View Document</a></p>
            @else
                <p class="text-muted">No file uploaded.</p>
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            @if(!empty($IIESAttachments['iies_scholarship_proof']))
                <p>Currently Attached: <a href="{{ Storage::url($IIESAttachments['iies_scholarship_proof']) }}" target="_blank">View Document</a></p>
            @else
                <p class="text-muted">No file uploaded.</p>
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            @if(!empty($IIESAttachments['iies_medical_confirmation']))
                <p>Currently Attached: <a href="{{ Storage::url($IIESAttachments['iies_medical_confirmation']) }}" target="_blank">View Document</a></p>
            @else
                <p class="text-muted">No file uploaded.</p>
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            @if(!empty($IIESAttachments['iies_caste_certificate']))
                <p>Currently Attached: <a href="{{ Storage::url($IIESAttachments['iies_caste_certificate']) }}" target="_blank">View Document</a></p>
            @else
                <p class="text-muted">No file uploaded.</p>
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            @if(!empty($IIESAttachments['iies_self_declaration']))
                <p>Currently Attached: <a href="{{ Storage::url($IIESAttachments['iies_self_declaration']) }}" target="_blank">View Document</a></p>
            @else
                <p class="text-muted">No file uploaded.</p>
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            @if(!empty($IIESAttachments['iies_death_certificate']))
                <p>Currently Attached: <a href="{{ Storage::url($IIESAttachments['iies_death_certificate']) }}" target="_blank">View Document</a></p>
            @else
                <p class="text-muted">No file uploaded.</p>
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            @if(!empty($IIESAttachments['iies_request_letter']))
                <p>Currently Attached: <a href="{{ Storage::url($IIESAttachments['iies_request_letter']) }}" target="_blank">View Document</a></p>
            @else
                <p class="text-muted">No file uploaded.</p>
            @endif
        </div>
