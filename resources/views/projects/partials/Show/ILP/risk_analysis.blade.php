...
<div class="mb-4 card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <div class="form-control">{{ isset($ILPRiskAnalysis['identified_risks']) ? $ILPRiskAnalysis['identified_risks'] : '' }}</div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-control">{{ isset($ILPRiskAnalysis['mitigation_measures']) ? $ILPRiskAnalysis['mitigation_measures'] : '' }}</div>
        </div>

        <!-- Business Sustainability -->
        <div class="mb-3">
            <label for="business_sustainability" class="form-label">Explain the sustainability of the business/enterprise:</label>
            <div class="form-control">{{ isset($ILPRiskAnalysis['business_sustainability']) ? $ILPRiskAnalysis['business_sustainability'] : '' }}</div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-control">{{ isset($ILPRiskAnalysis['expected_profits']) ? $ILPRiskAnalysis['expected_profits'] : '' }}</div>
        </div>
