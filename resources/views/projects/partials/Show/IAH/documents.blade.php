...
<div class="mb-4 card">
    ...
    <div class="card-body">
        @php
            // Ensure $documents is a single model instance
            $documents = $project->iahDocuments->first() ?? new \App\Models\OldProjects\IAH\ProjectIAHDocuments();
        @endphp
        ...
        <div class="mb-3">
            ...
            @if($documents && $documents->aadhar_copy)
                <p><small>Current file:
                    <a href="{{ asset('storage/' . $documents->aadhar_copy) }}" target="_blank">View Aadhar Copy</a>
                </small></p>
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            @if($documents && $documents->request_letter)
                <p><small>Current file:
                    <a href="{{ asset('storage/' . $documents->request_letter) }}" target="_blank">View Request Letter</a>
                </small></p>
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            @if($documents && $documents->medical_reports)
                <p><small>Current file:
                    <a href="{{ asset('storage/' . $documents->medical_reports) }}" target="_blank">View Medical Reports</a>
                </small></p>
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            @if($documents && $documents->other_docs)
                <p><small>Current file:
                    <a href="{{ asset('storage/' . $documents->other_docs) }}" target="_blank">View Other Documents</a>
                </small></p>
            @endif
        </div>
    </div>
