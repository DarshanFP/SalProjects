...
<div class="mb-3 card">
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <input type="file" name="file" id="file" class="mb-2 form-control" accept=".pdf" required onchange="checkFileSize(this)">

            <label for="file_name" class="form-label">File Name</label>
            <input type="text" name="file_name" class="mb-2 form-control" placeholder="Name of File Attached" required>

            <label for="description" class="form-label">Brief Description</label>
            <textarea name="description" class="form-control" rows="3" placeholder="Describe the file" required></textarea>
        </div>
