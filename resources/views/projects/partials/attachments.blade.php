...
<div class="mb-3 card">
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <input type="file" name="file" id="file" class="mb-2 form-control" accept=".pdf" onchange="checkFileSize(this)" style="background-color: #202ba3;">
            ...
            <textarea name="attachment_description" class="form-control" rows="3" placeholder="Describe the file" style="background-color: #202ba3;"></textarea>
        </div>
