<div class="mb-4 card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" placeholder="Enter beneficiary's name" style="background-color: #202ba3;" required>
        </div>

        <!-- Age -->
        <div class="mb-3">
            <label for="age" class="form-label">Age:</label>
            <input type="number" name="age" class="form-control" placeholder="Enter age" style="background-color: #202ba3;" required>
        </div>

        <!-- Gender -->
        <div class="mb-3">
            <label for="gender" class="form-label">Gender:</label>
            <select name="gender" class="form-control" style="background-color: #202ba3;" required>
        ...
        <div class="mb-3">
            ...
            <input type="date" name="dob" class="form-control" style="background-color: #202ba3;" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="contact_no" class="form-control" placeholder="Enter contact number" style="background-color: #202ba3;" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="address" class="form-control" rows="3" placeholder="Enter full address" style="background-color: #202ba3;" required></textarea>
        </div>

        <!-- Occupation -->
        <div class="mb-3">
            <label for="occupation" class="form-label">Occupation:</label>
            <input type="text" name="occupation" class="form-control" placeholder="Enter occupation" style="background-color: #202ba3;" required>
        </div>

        <!-- Marital Status -->
        <div class="mb-3">
            <label for="marital_status" class="form-label">Marital Status:</label>
            <select name="marital_status" class="form-control" style="background-color: #202ba3;" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="religion" class="form-control" placeholder="Enter religion" style="background-color: #202ba3;" required>
        </div>

        <!-- Caste -->
        <div class="mb-3">
            <label for="caste" class="form-label">Caste:</label>
            <input type="text" name="caste" class="form-control" placeholder="Enter caste" style="background-color: #202ba3;" required>
        </div>

        <!-- Present Family Situation -->
        <div class="mb-3">
            <label for="family_situation" class="form-label">Give details of the present family situation:</label>
            <textarea name="family_situation" class="form-control" rows="3" placeholder="Enter family situation" style="background-color: #202ba3;" required></textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="small_business_status" class="form-control" style="background-color: #202ba3;" required>
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="monthly_income" class="form-control" placeholder="Enter monthly income" style="background-color: #202ba3;" required>
        </div>

        <!-- Business Plan -->
        <div class="mb-3">
            <label for="business_plan" class="form-label">Explain the Beneficiary’s present business plan:</label>
            <textarea name="business_plan" class="form-control" rows="3" placeholder="Provide details of the business plan" style="background-color: #202ba3;" required></textarea>
        </div>
