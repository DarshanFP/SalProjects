...
<div class="mb-3 card">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="current_studies" class="form-control">
        </div>

        <div class="form-group">
            <label>Caste:</label>
            <input type="text" name="bcaste" class="form-control">
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" name="father_income" class="form-control">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" name="mother_income" class="form-control">
        </div>
    </div>
</div>
