...
<div class="mb-3 card">
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <textarea name="internal_challenges" class="form-control sustainability-textarea" rows="3" placeholder="Describe internal challenges"></textarea>
        </div>

        <div class="mb-3">
            <label for="external_challenges" class="form-label">(2) External challenges / Present difficulties</label>
            <textarea name="external_challenges" class="form-control sustainability-textarea" rows="3" placeholder="Describe external challenges"></textarea>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <textarea name="area_of_focus" class="form-control sustainability-textarea" rows="4" placeholder="Specify areas of focus"></textarea>
        </div>
    </div>
</div>
