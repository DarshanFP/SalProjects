{{-- resources/views/projects/partials/CCI/economic_background.blade.php --}}
<div class="mb-3 card">
    ...
    <div class="card-body">
            ...
            <table class="table table-bordered" id="cci-economic-background-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="number" name="agricultural_labour_number" class="form-control cci-eb-number"></td>
                    </tr>
                    <tr>
                        <td style="text-align: left;">Marginal farmers (less than two and half acres)</td>
                        <td><input type="number" name="marginal_farmers_number" class="form-control cci-eb-number"></td>
                    </tr>
                    <tr>
                        <td style="text-align: left;">Parents in self-employment</td>
                        <td><input type="number" name="self_employed_parents_number" class="form-control cci-eb-number"></td>
                    </tr>
                    <tr>
                        <td style="text-align: left;">Parents working in informal sector</td>
                        <td><input type="number" name="informal_sector_parents_number" class="form-control cci-eb-number"></td>
                    </tr>
                    <tr>
                        <td style="text-align: left;">Any other</td>
                        <td><input type="number" name="any_other_number" class="form-control cci-eb-number"></td>
                    </tr>
        ...
        <div class="mb-3">
            ...
            <textarea name="general_remarks" class="form-control sustainability-textarea" rows="3"></textarea>
        </div>
    </div>
</div>
