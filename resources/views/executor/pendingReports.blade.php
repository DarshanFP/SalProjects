        ...
        <div class="col-md-12 col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="fp-text-center1">My Pending Reports</h4>
                </div>
                <div class="card-body">
                    <!-- Filters -->
                    <div class="mb-4">
                        <form method="GET" action="{{ route('executor.report.pending') }}" class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                ...
                                <a href="{{ route('executor.report.pending') }}" class="btn btn-secondary">Reset</a>
                            </div>
                        </form>
                    </div>
