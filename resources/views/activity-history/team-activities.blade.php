@php
    $userRole = Auth::user()->role ?? 'provincial';
    $layout = match ($userRole) {
        'provincial' => 'provincial.dashboard',
        'coordinator' => 'coordinator.dashboard',
        default => 'provincial.dashboard',
    };
@endphp
        ...
        <div class="col-md-12 col-xl-12">
            <div class="mb-3 card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Status changes for all executors and applicants under you</p>
                </div>
                <div class="card-body">
                    {{-- Filters --}}
                    <form method="GET" action="{{ route('activities.team-activities') }}" class="mb-4">
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('activities.team-activities') }}" class="btn btn-secondary">Clear</a>
                            </div>
                        </div>
                    </form>
