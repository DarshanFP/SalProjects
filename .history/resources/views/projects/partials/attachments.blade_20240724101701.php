    ...
    <div class="card-body">
        <div id="attachments-container">
            <div class="mb-3 attachment-group" data-index="0">
                ...
                <input type="file" name="attachments[0][file]" class="mb-2 form-control" accept=".pdf,.doc,.docx,.xlsx">
                <label for="file_name[0]" class="form-label">File Name</label>
                <input type="text" name="file_name[0]" class="mb-2 form-control" placeholder="Name of File Attached" value="{{ old('file_name.0') }}">
                <textarea name="attachments[0][description]" class="form-control" rows="3" placeholder="Brief Description">{{ old('attachments.0.description') }}</textarea>
