...
<div class="mb-3 card">
    ...
    <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody class="budget-rows">
                        <tr>
                            ...
                            <td><input type="number" name="phases[0][budget][0][rate_quantity]" class="form-control select-input" value="{{ old('phases.0.budget.0.rate_quantity') }}" oninput="calculateBudgetRowTotals(this)"></td>
                            <td><input type="number" name="phases[0][budget][0][rate_multiplier]" class="form-control select-input" value="{{ old('phases.0.budget.0.rate_multiplier', 1) }}" oninput="calculateBudgetRowTotals(this)"></td>
                            <td><input type="number" name="phases[0][budget][0][rate_duration]" class="form-control select-input" value="{{ old('phases.0.budget.0.rate_duration', 1) }}" oninput="calculateBudgetRowTotals(this)"></td>
                            <td><input type="number" name="phases[0][budget][0][rate_increase]" class="form-control select-input" value="{{ old('phases.0.budget.0.rate_increase') }}" oninput="calculateBudgetRowTotals(this)"></td>
                            <td><input type="number" name="phases[0][budget][0][this_phase]" class="form-control readonly-input" value="{{ old('phases.0.budget.0.this_phase') }}" readonly></td>
        ...
        <div class="mt-3" style="margin-bottom: 20px;">
            ...
            <input type="number" name="total_amount_sanctioned" class="form-control readonly-input" value="{{ old('total_amount_sanctioned') }}" readonly>
        </div>
    </div>
</div>
