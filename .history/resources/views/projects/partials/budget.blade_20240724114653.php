...
<div class="mb-3 card">
    ...
    <div class="card-body">
        <div id="phases-container">
            <div class="phase-card" data-phase="0">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="phases[0][amount_sanctioned]" class="form-control select-input" required>
                </div>
                <table class="table table-bordered">
                    ...
                    <tbody class="budget-rows">
                        <tr>
                            <td><input type="text" name="phases[0][budget][0][particular]" class="form-control select-input"></td>
                            <td><input type="number" name="phases[0][budget][0][rate_quantity]" class="form-control select-input" oninput="calculateBudgetRowTotals(this)"></td>
                            <td><input type="number" name="phases[0][budget][0][rate_multiplier]" class="form-control select-input" value="1" oninput="calculateBudgetRowTotals(this)"></td>
                            <td><input type="number" name="phases[0][budget][0][rate_duration]" class="form-control select-input" value="1" oninput="calculateBudgetRowTotals(this)"></td>
                            <td><input type="number" name="phases[0][budget][0][rate_increase]" class="form-control select-input" oninput="calculateBudgetRowTotals(this)"></td>
                            <td><input type="number" name="phases[0][budget][0][this_phase]" class="form-control readonly-input" readonly></td>
                            <td><input type="number" name="phases[0][budget][0][next_phase]" class="form-control select-input"></td>
        ...
        <div class="mt-3" style="margin-bottom: 20px;">
            ...
            <input type="number" name="total_amount_sanctioned" class="form-control readonly-input" readonly>
        </div>
        <div class="mt-3" style="margin-bottom: 20px;">
            <label for="total_amount_forwarded" class="form-label">Total Amount Forwarded: Rs.</label>
            <input type="number" name="total_amount_forwarded" class="form-control readonly-input" readonly>
        </div>
    </div>
</div>
