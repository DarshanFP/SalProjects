...
<div class="card-body">
    ...
    <div class="mb-3">
        ...
        <select name="current_phase" id="current_phase" class="form-control readonly-select" required>
            ...
            <option value="1" {{ old('current_phase') == 1 ? 'selected' : '' }}>Phase 1</option>
            <option value="2" {{ old('current_phase') == 2 ? 'selected' : '' }}>Phase 2</option>
            <option value="3" {{ old('current_phase') == 3 ? 'selected' : '' }}>Phase 3</option>
            <option value="4" {{ old('current_phase') == 4 ? 'selected' : '' }}>Phase 4</option>
        </select>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="number" name="overall_project_budget" id="overall_project_budget" class="form-control readonly-input" value="{{ old('overall_project_budget') }}" required>
    </div>
    <div class="mb-3">
        @php
