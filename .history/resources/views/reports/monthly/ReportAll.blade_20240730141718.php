                    ...
                    <div class="mb-3 card objective" data-index="1">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <textarea name="objective[1]" class="form-control" rows="2" style="background-color: #202ba3;"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="expected_outcome[1]" class="form-label">Expected Outcome</label>
                                <textarea name="expected_outcome[1]" class="form-control" rows="2" style="background-color: #202ba3;"></textarea>
                            </div>
                                ...
                                <div class="mb-3 card activity" data-activity-index="1">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="summary_activities[1][1][1]" class="form-control" rows="3" style="background-color: #202ba3;"></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="qualitative_quantitative_data[1][1][1]" class="form-label">Qualitative & Quantitative Data</label>
                                            <textarea name="qualitative_quantitative_data[1][1][1]" class="form-control" rows="3" style="background-color: #202ba3;"></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="intermediate_outcomes[1][1][1]" class="form-label">Intermediate Outcomes</label>
                                            <textarea name="intermediate_outcomes[1][1][1]" class="form-control" rows="3" style="background-color: #202ba3;"></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="not_happened[1]" class="form-control" rows="3" style="background-color: #202ba3;"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="why_not_happened[1]" class="form-label">Explain Why Some Activities Could Not Be Undertaken</label>
                                <textarea name="why_not_happened[1]" class="form-control" rows="3" style="background-color: #202ba3;"></textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3 d-none" id="why_changes_container_1">
                                ...
                                <textarea name="why_changes[1]" class="form-control" rows="3" style="background-color: #202ba3;"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="lessons_learnt[1]" class="form-label">What Are the Lessons Learnt?</label>
                                <textarea name="lessons_learnt[1]" class="form-control" rows="3" style="background-color: #202ba3;"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="todo_lessons_learnt[1]" class="form-label">What Will Be Done Differently Because of the Learnings?</label>
                                <textarea name="todo_lessons_learnt[1]" class="form-control" rows="3" style="background-color: #202ba3;"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="col-sm-4"> <
                                    ...
                                    <input type="date" name="date[1]" class="form-control"  style="background-color: #202ba3;">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="plan_next_month[1]" class="form-label">Action Plan for Next Month</label>
                                <textarea name="plan_next_month[1]" class="form-control" rows="3"  style="background-color: #202ba3;"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {{-- <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="d-flex">
                                <input type="date" name="account_period_start" class="form-control" style="background-color: #202ba3;">
                                <span class="mx-6">To</span>
                                <input type="date" name="account_period_end" class="form-control" style="background-color: #202ba3;">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="account-rows">
                                <tr>
                                    <td><input type="text" name="particulars[]" class="form-control" value="{{ old('particulars.'.$index, $budget->particular) }}" style="background-color: #202ba3;"></td>
