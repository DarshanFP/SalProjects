                ...
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="project_type" class="form-control" value="{{ $project->project_type }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="project_id" class="form-label">Project Type</label>
                            <input type="text" name="project_id" class="form-control" value="{{ $project->project_id }}" readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="month" name="report_month_year" class="form-control">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mb-3 card outlook" data-index="1">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="date" name="date[1]" class="form-control fp-custom-date-input">
                            </div>
                            <div class="mb-3">
                ...
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="amount_forwarded_overview" class="form-control" value="{{ $project->amount_forwarded }}" readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="account-rows">
                                ...
                                <tr>
                                    <td><input type="text" name="particulars[]" class="form-control" value="{{ $budget->particular }}"></td>
