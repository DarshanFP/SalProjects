                    ...
                    <div class="mb-3 card objective" data-index="1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <input type="radio" name="changes[1]" value="1" onclick="toggleWhyChanges(this, 1)"> Yes
                                    <input type="radio" name="changes[1]" value="0" onclick="toggleWhyChanges(this, 1)"> No
                                </div>
                            </div>
        ...
        newObjective.innerHTML = `
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input type="radio" name="changes[${newIndex}]" value="1" onclick="toggleWhyChanges(this, ${newIndex})"> Yes
                        <input type="radio" name="changes[${newIndex}]" value="0" onclick="toggleWhyChanges(this, ${newIndex})"> No
                    </div>
                </div>
