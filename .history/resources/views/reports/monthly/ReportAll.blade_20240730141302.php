                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="col-sm-4"> <
                                    ...
                                    <input type="date" name="date[1]" class="form-control"  style="background-color: #6571ff;">
                                </div>
                            </div>
                            <div class="mb-3">
                ...
                {{-- <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="amount_sanctioned_overview" class="form-control" oninput="calculateTotalAmount()"  value="{{ old('amount_sanctioned_overview', $amountSanctioned ?? 0.00) }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="amount_forwarded_overview" class="form-label">Amount Forwarded from the Last Financial Year: Rs.</label>
                            <input type="number" name="amount_forwarded_overview" class="form-control" oninput="calculateTotalAmount()" value="{{ old('amount_forwarded_overview', $amountForwarded ?? 0.00) }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="amount_in_hand" class="form-label">Total Amount: Rs.</label>
                            <input type="number" name="amount_in_hand" class="form-control" value="{{ old('amount_in_hand', ($amountSanctioned ?? 0.00) + ($amountForwarded ?? 0.00)) }}" readonly>
                        </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="account-rows">
                                <tr>
                                    <td><input type="text" name="particulars[]" class="form-control" value="{{ old('particulars.'.$index, $budget->particular) }}" style="background-color: #6571ff;"></td>
