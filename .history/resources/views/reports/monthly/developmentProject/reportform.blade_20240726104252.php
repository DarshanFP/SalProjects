        ...
        <div class="col-md-12 col-xl-12">
            <form action="{{ route('monthly.developmentProject.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="project_type" class="form-label">Title of the Project</label>
                            <input type="text" name="project_type" class="form-control" value="{{ $project->project_title }}" readonly>
                        </div>
                        <div class="mb-3">
