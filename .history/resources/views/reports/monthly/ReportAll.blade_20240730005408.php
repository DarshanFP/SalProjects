            ...
            <form action="{{ route('monthly.report.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="project_title" class="form-label">Project Type</label>
                            <input type="text" name="project_title" class="form-control readonly-input" value="{{ $project->project_type }}" readonly>
                        </div>
                        <div class="mb-3">
