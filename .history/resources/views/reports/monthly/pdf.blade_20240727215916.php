...
<body>
    ...
    <table class="details-table">
        @foreach($report->objectives as $objective)
            ...
            <tr>
                <td class="details-label">Not Happened:</td>
                <td>{{ $objective->not_happened }}</td>
            </tr>
            <tr>
                <td class="details-label">Why Not Happened:</td>
            ...
            <tr>
                <td class="details-label">Why Changes:</td>
            ...
            <tr>
                <td class="details-label">Todo Lessons Learnt:</td>
    ...
    <table class="account-table">
        <tr>
            ...
            <td>{{ $report->account_period_start }} to {{ $report->account_period_end }}</td>
        </tr>
        <tr>
