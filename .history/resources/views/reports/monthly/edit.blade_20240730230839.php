        ...
        <div class="col-md-12 col-xl-12">
            <form action="{{ route('monthly.report.update', $report->report_id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 card">
                    ...
                    <div class="card-header">
                        <h4 class="fp-text-margin">Basic Information
                        class="align-middle fp-text-margin">Project Type</h4>
                        <h4 class="fp-text-margin">{{ $report->report_id }}"</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="total_beneficiaries" class="form-control" value="{{ old('total_beneficiaries', $report->total_beneficiaries) }}" style="background-color: #6571ff;">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 card objective" data-index="{{ $index + 1 }}">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea name="objective[{{ $index + 1 }}]" class="form-control" rows="2" style="background-color: #6571ff;">{{ old('objective.' . ($index + 1), $objective->objective) }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="expected_outcome[{{ $index + 1 }}]" class="form-label">Expected Outcome</label>
                                    <textarea name="expected_outcome[{{ $index + 1 }}]" class="form-control" rows="2" style="background-color: #6571ff;">{{ old('expected_outcome.' . ($index + 1), $objective->expected_outcome) }}</textarea>
                                </div>
                                        ...
                                        <div class="mb-3 card activity" data-activity-index="{{ $activityIndex + 1 }}">
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                <div class="form-group">
                                                    ...
                                                    <select name="month[{{ $index + 1 }}][{{ $activityIndex + 1 }}]" class="form-control" style="background-color: #6571ff;">
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="summary_activities[{{ $index + 1 }}][{{ $activityIndex + 1 }}]" class="form-control" rows="3" style="background-color: #6571ff;">{{ old('summary_activities.' . ($index + 1) . '.' . ($activityIndex + 1), $activity->summary_activities) }}</textarea>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="qualitative_quantitative_data[{{ $index + 1 }}][{{ $activityIndex + 1 }}]" class="form-label">Qualitative & Quantitative Data</label>
                                                    <textarea name="qualitative_quantitative_data[{{ $index + 1 }}][{{ $activityIndex + 1 }}]" class="form-control" rows="3" style="background-color: #6571ff;">{{ old('qualitative_quantitative_data.' . ($index + 1) . '.' . ($activityIndex + 1), $activity->qualitative_quantitative_data) }}</textarea>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="intermediate_outcomes[{{ $index + 1 }}][{{ $activityIndex + 1 }}]" class="form-label">Intermediate Outcomes</label>
                                                    <textarea name="intermediate_outcomes[{{ $index + 1 }}][{{ $activityIndex + 1 }}]" class="form-control" rows="3" style="background-color: #6571ff;">{{ old('intermediate_outcomes.' . ($index + 1) . '.' . ($activityIndex + 1), $activity->intermediate_outcomes) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="not_happened[{{ $index + 1 }}]" class="form-control" rows="3" style="background-color: #6571ff;">{{ old('not_happened.' . ($index + 1), $objective->not_happened) }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="why_not_happened[{{ $index + 1 }}]" class="form-label">Explain Why Some Activities Could Not Be Undertaken</label>
                                    <textarea name="why_not_happened[{{ $index + 1 }}]" class="form-control" rows="3" style="background-color: #6571ff;">{{ old('why_not_happened.' . ($index + 1), $objective->why_not_happened) }}</textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3 {{ old('changes.' . ($index + 1), $objective->changes) == 1 ? '' : 'd-none' }}" id="why_changes_container_{{ $index + 1 }}">
                                    ...
                                    <textarea name="why_changes[{{ $index + 1 }}]" class="form-control" rows="3" style="background-color: #6571ff;">{{ old('why_changes.' . ($index + 1), $objective->why_changes) }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="lessons_learnt[{{ $index + 1 }}]" class="form-label">What Are the Lessons Learnt?</label>
                                    <textarea name="lessons_learnt[{{ $index + 1 }}]" class="form-control" rows="3" style="background-color: #6571ff;">{{ old('lessons_learnt.' . ($index + 1), $objective->lessons_learnt) }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="todo_lessons_learnt[{{ $index + 1 }}]" class="form-label">What Will Be Done Differently Because of the Learnings?</label>
                                    <textarea name="todo_lessons_learnt[{{ $index + 1 }}]" class="form-control" rows="3" style="background-color: #6571ff;">{{ old('todo_lessons_learnt.' . ($index + 1), $objective->todo_lessons_learnt) }}</textarea>
                                </div>
                            </div>
                        </div>
                    @endforeach
                        ...
                        <div class="mb-3 card outlook" data-index="{{ $index + 1 }}">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="date[{{ $index + 1 }}]" class="form-control" value="{{ old('date.' . ($index + 1), $outlook->date) }}" style="background-color: #6571ff;">
                                </div>
                                <div class="mb-3">
                                    <label for="plan_next_month[{{ $index + 1 }}]" class="form-label">Action Plan for Next Month</label>
                                    <textarea name="plan_next_month[{{ $index + 1 }}]" class="form-control" rows="3" style="background-color: #6571ff;">{{ old('plan_next_month.' . ($index + 1), $outlook->plan_next_month) }}</textarea>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="d-flex">
                                <input type="date" name="account_period_start" class="form-control" value="{{ old('account_period_start', $report->account_period_start) }}" style="background-color: #6571ff;">
                                <span class="mx-2">to</span>
                                <input type="date" name="account_period_end" class="form-control" value="{{ old('account_period_end', $report->account_period_end) }}" style="background-color: #6571ff;">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="account-rows">
                                @foreach ($report->accountDetails as $index => $accountDetail)
                                    <tr>
                                        <td><input type="text" name="particulars[]" class="form-control" value="{{ old('particulars.' . $index, $accountDetail->particulars) }}" style="background-color: #6571ff;"></td>
                                        <td><input type="number" name="amount_forwarded[]" class="form-control" value="{{ old('amount_forwarded.' . $index, $accountDetail->amount_forwarded) }}" oninput="calculateRowTotals(this.closest('tr'))" style="background-color: #6571ff;"></td>
                                        ...
                                        <td><input type="number" name="expenses_last_month[]" class="form-control" value="{{ old('expenses_last_month.' . $index, $accountDetail->expenses_last_month) }}" oninput="calculateRowTotals(this.closest('tr'))" style="background-color: #6571ff;"></td>
                                        <td><input type="number" name="expenses_this_month[]" class="form-control" value="{{ old('expenses_this_month.' . $index, $accountDetail->expenses_this_month) }}" oninput="calculateRowTotals(this.closest('tr'))" style="background-color: #6571ff;"></td>
                        ...
                        <div id="photos-container">
                            @foreach($report->photos as $index => $photo)
                                <div class="mb-3 photo-group" data-index="{{ $index + 1 }}">
                                    ...
                                    <textarea name="photo_descriptions[]" class="form-control" rows="3" placeholder="Brief Description (WHO WHERE WHAT WHEN)" style="background-color: #6571ff;">{{ old('photo_descriptions.' . $index, $photo->description) }}</textarea>
            ...
            <div class="mb-3 card objective" data-index="${index}">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea name="objective[${index}]" class="form-control" rows="2" style="background-color: #6571ff;"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="expected_outcome[${index}]" class="form-label">Expected Outcome</label>
                        <textarea name="expected_outcome[${index}]" class="form-control" rows="2" style="background-color: #6571ff;"></textarea>
                    </div>
                    <h4>Monthly Summary</h4>
                        ...
                        <div class="mb-3 card activity" data-activity-index="1">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="form-group">
                                    ...
                                    <select name="month[${index}][1]" class="form-control" style="background-color: #6571ff;">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea name="summary_activities[${index}][1][1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="qualitative_quantitative_data[${index}][1][1]" class="form-label">Qualitative & Quantitative Data</label>
                                    <textarea name="qualitative_quantitative_data[${index}][1][1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="intermediate_outcomes[${index}][1][1]" class="form-label">Intermediate Outcomes</label>
                                    <textarea name="intermediate_outcomes[${index}][1][1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                                </div>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="not_happened[${index}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="why_not_happened[${index}]" class="form-label">Explain Why Some Activities Could Not Be Undertaken</label>
                        <textarea name="why_not_happened[${index}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="lessons_learnt[${index}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="todo_lessons_learnt[${index}]" class="form-label">What Will Be Done Differently Because of the Learnings?</label>
                        <textarea name="todo_lessons_learnt[${index}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                    </div>
                </div>
            </div>
        `;
            ...
            <div class="mb-3 card activity" data-activity-index="${activityIndex}">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="form-group">
                        ...
                        <select name="month[${objectiveIndex}][${activityIndex}]" class="form-control" style="background-color: #6571ff;">
                            <option value="" disabled selected>Select Month</option>
                            ${['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'].map(month => `<option value="${month}">${month}</option>`).join('')}
                        </select>
                    </div>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea name="summary_activities[${objectiveIndex}][${activityIndex}][1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea name="qualitative_quantitative_data[${objectiveIndex}][${activityIndex}][1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="intermediate_outcomes[${objectiveIndex}][${activityIndex}][1]" class="form-label">Intermediate Outcomes</label>
                        <textarea name="intermediate_outcomes[${objectiveIndex}][${activityIndex}][1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                    </div>
                </div>
            ...
            <div class="mb-3 card outlook" data-index="${index}">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="date" name="date[${index}]" class="form-control fp-custom-date-input" style="background-color: #6571ff;">
                    </div>
                    <div class="mb-3">
                        <label for="plan_next_month[${index}]" class="form-label">Action Plan for Next Month</label>
                        <textarea name="plan_next_month[${index}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                    </div>
                </div>
            </div>
        `;
