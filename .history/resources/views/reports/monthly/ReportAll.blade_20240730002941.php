                ...
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="amount_forwarded_overview" class="form-control" oninput="calculateTotalAmount()" value="{{ old('amount_forwarded_overview', $amountForwarded ?? 0.00) }}" style="background-color: #6571ff;">>
                        </div>
                        <div class="mb-3">
