<div class="mb-3 card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="amount_sanctioned_overview" class="form-control" value="{{ old('amount_sanctioned_overview', $amountSanctioned ?? 0.00) }}" style="background-color: #6571ff;">
        </div>
        <div class="mb-3">
            <label for="amount_forwarded_overview" class="form-label">Amount Forwarded from the Last Financial Year: Rs.</label>
            <input type="number" name="amount_forwarded_overview" class="form-control" value="{{ old('amount_forwarded_overview', $amountForwarded ?? 0.00) }}" style="background-color: #6571ff;">
        </div>
        <div class="mb-3">
        ...
        <table class="table table-bordered">
            ...
            <tbody id="account-rows">
                ...
                <tr>
                    ...
                    <td><input type="number" name="amount_forwarded[]" class="form-control" value="{{ old('amount_forwarded.'.$index, 0.00) }}" oninput="calculateRowTotals(this.closest('tr'))" readonly></td>
                    <td><input type="number" name="amount_sanctioned[]" class="form-control" value="{{ old('amount_sanctioned.'.$index, $budget->this_phase ?? 0.00) }}" oninput="calculateRowTotals(this.closest('tr'))" style="background-color: #6571ff;"></td>
