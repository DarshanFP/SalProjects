<div class="mb-3 card">
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <div class="d-flex">
                <input type="date" name="account_period_start" class="form-control @error('account_period_start') is-invalid @enderror" style="background-color: #6571ff;">
                @error('account_period_start')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                <span class="mx-2">to</span>
                <input type="date" name="account_period_end" class="form-control @error('account_period_end') is-invalid @enderror" style="background-color: #6571ff;">
        ...
        <table class="table table-bordered">
            ...
            <tbody id="account-rows">
                ...
                <tr>
                    ...
                    <td><input type="number" name="amount_forwarded[]" class="form-control" value="{{ old('amount_forwarded.'.$index, 0.00) }}" oninput="calculateRowTotals(this.closest('tr'))" style="background-color: #202ba3;"></td>
                    ...
                    <td><input type="number" name="expenses_this_month[]" class="form-control" oninput="calculateRowTotals(this.closest('tr'))" style="background-color: #6571ff;"></td> 202ba3
