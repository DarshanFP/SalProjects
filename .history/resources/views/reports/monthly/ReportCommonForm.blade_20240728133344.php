                    ...
                    <div class="mb-3 card objective" data-index="1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="lessons_learnt[1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="todo_lessons_learnt[1]" class="form-label">What Will Be Done Differently Because of the Learnings?</label>
                                <textarea name="todo_lessons_learnt[1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mb-3 card outlook" data-index="1">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="date" name="date[1]" class="form-control fp-custom-date-input" style="background-color: #6571ff;">
                            </div>
                            <div class="mb-3">
                                <label for="plan_next_month[1]" class="form-label">Action Plan for Next Month</label>
                                <textarea name="plan_next_month[1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="account-rows">
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" name="expenses_last_month[]" class="form-control" value="{{ old('expenses_last_month.'.$index) }}" oninput="calculateRowTotals(this)" style="background-color: #6571ff;"></td>
                                    <td><input type="number" name="expenses_this_month[]" class="form-control" value="{{ old('expenses_this_month.'.$index) }}" oninput="calculateRowTotals(this)" style="background-color: #6571ff;"></td>
                                    ...
                                    <td><button type="button" class="btn btn-danger btn-sm" onclick="removeAccountRow(this)">Remove</button>
                                @endforeach
                            </tbody>
                            <tfoot>
                                <tr>
