                ...
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="place" class="form-control readonly-input" value="{{ Auth::user()->center }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="society_name" class="form-label">Name of the Society / Trust</label>
                            <input type="text" name="society_name" class="form-control readonly-input" value="{{ Auth::user()->society_name }}" readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="in_charge" class="form-control readonly-input" value="{{ Auth::user()->name }}" readonly>
                        </div>
                        <div class="mb-3">
...
<script>
    ...
    function addAccountRow() {
        const tableBody = document.querySelector('#account-rows');
        const newRow = document.createElement('tr');
        newRow.innerHTML = `
            <td><input type="text" name="particulars[]" class="form-control" style="background-color: #6571ff;" required></td>
            <td><input type="number" name="amount_forwarded[]" class="form-control" value="0.00" readonly></td>
            <td><input type="number" name="amount_sanctioned[]" class="form-control" value="0.00" oninput="calculateRowTotals(this.closest('tr'))" style="background-color: #6571ff;" required></td>
            <td><input type="number" name="total_amount[]" class="form-control" value="0.00" readonly></td>
            <td><input type="number" name="expenses_last_month[]" class="form-control" value="0.00" readonly></td>
            <td><input type="number" name="expenses_this_month[]" class="form-control" oninput="calculateRowTotals(this.closest('tr'))" style="background-color: #6571ff;" required></td>
