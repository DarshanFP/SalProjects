    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-xl-12">
            <form action="{{ route('monthly.report.store') }}" method="POST" enctype="multipart/form-data">
                ...
                {{-- <input type="hidden" name="report_id" value="{{ $newReportId }}"> --}}
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="account-rows">
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" name="amount_sanctioned[]" class="form-control" value="{{ $budget->this_phase }}" oninput="calculateRowTotals(this)" style="background-color: #6571ff;"></td>
                                    <td><input type="number" name="total_amount[]" class="form-control" value="{{ $budget->amount_forwarded + $budget->this_phase }}" readonly></td>
                                    <td><input type="number" name="expenses_last_month[]" class="form-control" value="{{ $expensesUpToLastMonth[$budget->id] ?? 0 }}" oninput="calculateRowTotals(this)" style="background-color: #6571ff;"></td>
                        ...
                        <div class="mb-3 card activity" data-activity-index="1">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="form-group">
                                    ...
                                    <select name="month[${index}][${activityIndex}]" class="form-control" style="background-color: #6571ff;">
                                        <option value="" disabled selected>Select Month</option>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea name="summary_activities[${index}][${activityIndex}][1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="qualitative_quantitative_data[${index}][${activityIndex}][1]" class="form-label">Qualitative & Quantitative Data</label>
                                    <textarea name="qualitative_quantitative_data[${index}][${activityIndex}][1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="intermediate_outcomes[${index}][${activityIndex}][1]" class="form-label">Intermediate Outcomes</label>
                                    <textarea name="intermediate_outcomes[${index}][${activityIndex}][1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                                </div>
                            </div>
