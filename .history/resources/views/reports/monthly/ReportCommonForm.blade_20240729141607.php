        ...
        newObjective.innerHTML = `
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <textarea name="objective[${newIndex}]" class="form-control" rows="2" style="background-color: #6571ff;"></textarea>
                </div>
                <div class="mb-3">
                    <label for="expected_outcome[${newIndex}]" class="form-label">Expected Outcome</label>
                    <textarea name="expected_outcome[${newIndex}]" class="form-control" rows="2" style="background-color: #6571ff;"></textarea>
                </div>
                <h4>Monthly Summary</h4>
                    ...
                    <div class="mb-3 card activity" data-activity-index="1">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div class="form-group">
                                ...
                                <select name="month[${newIndex}][1]" class="form-control" style="background-color: #6571ff;">
                                    <option value="" disabled selected>Select Month</option>
                                    @foreach(['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'] as $month)
                                        <option value="{{ $month }}">{{ $month }}</option>
                                    @endforeach
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <textarea name="summary_activities[${newIndex}][1][1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="qualitative_quantitative_data[${newIndex}][1][1]" class="form-label">Qualitative & Quantitative Data</label>
                                <textarea name="qualitative_quantitative_data[${newIndex}][1][1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="intermediate_outcomes[${newIndex}][1][1]" class="form-label">Intermediate Outcomes</label>
                                <textarea name="intermediate_outcomes[${newIndex}][1][1]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                            </div>
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="not_happened[${newIndex}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                </div>
                <div class="mb-3">
                    <label for="why_not_happened[${newIndex}]" class="form-label">Explain Why Some Activities Could Not Be Undertaken</label>
                    <textarea name="why_not_happened[${newIndex}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3 d-none" id="why_changes_container_${newIndex}">
                    ...
                    <textarea name="why_changes[${newIndex}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                </div>
                <div class="mb-3">
                    <label for="lessons_learnt[${newIndex}]" class="form-label">What Are the Lessons Learnt?</label>
                    <textarea name="lessons_learnt[${newIndex}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                </div>
                <div class="mb-3">
                    <label for="todo_lessons_learnt[${newIndex}]" class="form-label">What Will Be Done Differently Because of the Learnings?</label>
                    <textarea name="todo_lessons_learnt[${newIndex}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                </div>
            </div>
        `;
        ...
        newActivity.innerHTML = `
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="form-group">
                    ...
                    <select name="month[${objectiveIndex}][${newIndex}]" class="form-control" style="background-color: #6571ff;">
                        <option value="" disabled selected>Select Month</option>
                        @foreach(['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'] as $month)
                            <option value="{{ $month }}">{{ $month }}</option>
                        @endforeach
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <textarea name="summary_activities[${objectiveIndex}][${newIndex}][${newIndex}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                </div>
                <div class="mb-3">
                    ...
                    <textarea name="qualitative_quantitative_data[${objectiveIndex}][${newIndex}][${newIndex}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                </div>
                <div class="mb-3">
                    <label for="intermediate_outcomes[${objectiveIndex}][${newIndex}][${newIndex}]" class="form-label">Intermediate Outcomes</label>
                    <textarea name="intermediate_outcomes[${objectiveIndex}][${newIndex}][${newIndex}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                </div>
            </div>
        ...
        newOutlook.innerHTML = `
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="date" name="date[${newIndex}]" class="form-control" style="background-color: #6571ff;">
                </div>
                <div class="mb-3">
                    <label for="plan_next_month[${newIndex}]" class="form-label">Action Plan for Next Month</label>
                    <textarea name="plan_next_month[${newIndex}]" class="form-control" rows="3" style="background-color: #6571ff;"></textarea>
                </div>
            </div>
        `;
