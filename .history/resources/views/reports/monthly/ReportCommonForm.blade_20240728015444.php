                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="account-rows">
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" name="amount_forwarded[]" class="form-control" value="{{ old('amount_forwarded.'.$index) }}" oninput="calculateRowTotals(this.closest('tr'))" style="background-color: #6571ff;" required></td>
                                    ...
                                    <td><input type="number" name="expenses_last_month[]" class="form-control" value="{{ $expensesUpToLastMonth[$budget->particular] ?? 0 }}" oninput="calculateRowTotals(this.closest('tr'))" readonly></td>
