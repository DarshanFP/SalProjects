...
class AttachmentController extends Controller
{
    public function store(Request $request, $project_id)
    {
        ...
        try {
            ...
            Log::info('Attachments stored successfully', ['project_id' => $project_id]);
            return redirect()->route('projects.show', $project_id)->with('success', 'Attachments uploaded successfully.');
        } catch (\Exception $e) {
