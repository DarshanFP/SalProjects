...
class ReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Log::info('User authentication checked', ['user_id' => $user_id]);
        ...
        Log::info('Report ID generated', ['report_id' => $report_id]);
        ...
        Log::info('Report created successfully', ['report' => $report]);
