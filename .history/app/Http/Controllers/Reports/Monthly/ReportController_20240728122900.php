...
class ReportController extends Controller
{
    ...
    public function create($project_id)
{
    Log::info('Fetching project details for project_id: ' . $project_id);
    ...
    Log::info('Fetching last report for project_id: ' . $project_id);
    ...
    if ($lastReport) {
        ...
        $lastExpenses = DPAccountDetail::where('report_id', $lastReport->report_id)
            ->pluck('total_expenses')->toArray();
        Log::info('Fetched last expenses: ', ['lastExpenses' => $lastExpenses]);
    } else {
        Log::info('No last report found for project_id: ' . $project_id);
    }
