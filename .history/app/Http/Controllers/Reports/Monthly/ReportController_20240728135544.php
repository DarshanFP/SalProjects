    ...
    public function update(Request $request, $report_id)
    {
        ...
        try {
            ...
            foreach ($request->particulars as $index => $particular) {
                ...
                $accountDetail->updateExpensesAndBalance($request->expenses_last_month[$index], $request->expenses_this_month[$index]);
                \Log::info('DPAccountDetail created', ['dpAccountDetail' => $accountDetail]);
            }
