    ...
    public function store(Request $request)
{
    ...
    //             }
    //         }
    //         //TEST OBJECTIVE AND ACTIVITY ENDS
    ...
    //     if (!is_array($months)) {
    //         \Log::error('Expected months to be an array.', ['data' => $months]);
    //         return;
    //     }

    //     foreach ($months as $i => $month) {
    //         $activity_id_suffix = str_pad($i + 1, 3, '0', STR_PAD_LEFT);
    //         $activity_id = "{$objective_id}-{$activity_id_suffix}";
    ...
    //                 'objective_id' => $objective_id,
    //                 'month' => $month,
    //                 'summary_activities' => $summary_activities[$i][0]['1'] ?? 'Default summary',
    //                 'qualitative_quantitative_data' => $qualitative_data[$i][0]['1'] ?? 'Default qualitative data',
    //                 'intermediate_outcomes' => $outcomes[$i][0]['1'] ?? 'Default outcome',
    //             ]);
    //         } catch (\Exception $e) {
    ...
    //                 'data' => [
    //                     'month' => $month,
    //                     'summary' => $summary_activities[$i][0]['1'] ?? 'Default summary',
    //                     'qualitative' => $qualitative_data[$i][0]['1'] ?? 'Default qualitative data',
    //                     'outcome' => $outcomes[$i][0]['1'] ?? 'Default outcome',
    //                 ]
    //             ]);
    //         }
    //     }
