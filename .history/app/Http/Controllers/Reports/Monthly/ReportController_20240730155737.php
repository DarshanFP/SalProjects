    ...
    private function createActivity($request, $objective_id, $objectiveIndex, $monthIndex, $activityIndex, $month) {
        ...
        try {
            DPActivity::create([
                ...
                'objective_id' => $objective_id,
                'month' => $month,
                'summary_activities' => $summary ?? 'Default summary if null',
                'qualitative_quantitative_data' => $qualitative ?? 'Default qualitative data if null',
                'intermediate_outcomes' => $outcomes ?? 'Default outcomes if null'
            ]);
        } catch (\Exception $e) {
