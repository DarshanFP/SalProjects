...
class ReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['report_id'] = $report_id;
        ...
        // The rest of your store function handling objectives, photos, outlooks...
        // Be sure to continue to use $validatedData['report_id'] wherever you need the report id.
