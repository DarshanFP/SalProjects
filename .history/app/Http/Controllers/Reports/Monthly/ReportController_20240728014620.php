...
class ReportController extends Controller
{
    ...
    {
        $latestTotalExpenses = DPAccountDetail::where('report_id', function($query) use ($project_id) {
    ...
    public function create($project_id)
{
    ...
    // Create an array to store expenses up to the last month for each budget
    $expensesUpToLastMonth = [];
    foreach ($budgets as $budget) {
        $expensesUpToLastMonth[$budget->id] = $this->fetchLatestTotalExpenses($project->project_id);
    }
