...
class ReportController extends Controller
{
    public function create($project_id)
    {
        ...
        // Calculate total expenses up to last report
        ...
        $remainingFunds = $amountSanctioned - $expensesUpToLastMonth;

        $user = Auth::user();
        $newReportId = Str::uuid();

        return view('reports.monthly.ReportCommonForm', compact('project', 'user', 'amountSanctioned', 'amountForwarded', 'budgets', 'expensesUpToLastMonth', 'newReportId', 'remainingFunds'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($request->particulars as $index => $particular) {
                ...
                // Calculate and update balance after each entry
                $dpAccountDetail->updateBalance();
            }
