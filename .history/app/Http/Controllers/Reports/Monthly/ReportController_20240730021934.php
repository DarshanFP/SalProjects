    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($objectives as $index => $objective) {
                ...
                Log::info('Objective created', ['objective_id' => $createdObjective->id]);
                ...
                foreach ($activityMonths as $activityIndex => $month) {
                    ...
                    Log::info('Activity created', ['activity_id' => $createdActivity->id]);
                }
            }
            ...
            foreach ($particulars as $index => $particular) {
                $account_detail_id_suffix = str_pad($index + 1, 3, '0', STR_PAD_LEFT);
                $account_detail_id = "{$report_id}-{$account_detail_id_suffix}";
                ...
                Log::info('Account detail created', ['account_detail_id' => $createdAccountDetail->id]);
            }
            ...
            foreach ($outlookDates as $index => $date) {
                ...
                Log::info('Outlook created', ['outlook_id' => $createdOutlook->id]);
            }
