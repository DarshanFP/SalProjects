...
use App\Http\Controllers\Reports\Monthly\ExportRController;
...
Route::prefix('reports/monthly')->group(function () {
    ...
    Route::post('update/{report_id}', [ReportController::class, 'update'])->name('monthly.report.update');
    ...
    Route::get('reports/monthly/downloadPdf/{report_id}', [App\Http\Controllers\Reports\Monthly\ExportController::class, 'downloadPdf'])->name('monthly.report.downloadPdf');
    Route::get('reports/monthly/downloadDoc/{report_id}', [App\Http\Controllers\Reports\Monthly\ExportController::class, 'downloadDoc'])->name('monthly.report.downloadDoc');
