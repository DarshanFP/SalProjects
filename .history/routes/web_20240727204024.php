...
Route::prefix('reports/monthly')->group(function () {
    ...
    Route::get('reports/monthly/downloadDoc/{report_id}', [App\Http\Contrllers\Reports\Monthly\ExportController::class, 'downloadDoc'])->name('monthly.report.downloadDoc');
