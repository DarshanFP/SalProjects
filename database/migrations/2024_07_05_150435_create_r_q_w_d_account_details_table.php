...
class CreateRqwdAccountDetailsTable extends Migration
{
    public function up()
    {
        Schema::create('rqwd_account_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('rqwd_account_details');
    }
}
