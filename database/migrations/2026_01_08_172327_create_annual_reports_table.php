...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('annual_reports', function (Blueprint $table) {
            $table->id();
            $table->string('report_id')->unique(); // e.g., 'AR-2025-DP-0001'
            ...
            $table->json('generated_from')->nullable()->comment('Array of half-yearly/quarterly/monthly report IDs used to generate this report');
