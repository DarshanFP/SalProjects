...
class HalfYearlyReport extends Model
{
    ...
    {
        return $this->hasMany(HalfYearlyReportDetail::class, 'half_yearly_report_id');
    }
    ...
    {
        $halfYearNames = [1 => 'H1', 2 => 'H2'];
        return ($halfYearNames[$this->half_year] ?? 'H' . $this->half_year) . ' ' . $this->year;
    }
